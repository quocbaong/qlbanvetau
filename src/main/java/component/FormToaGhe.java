...
public class FormToaGhe extends javax.swing.JPanel {
    ...
    public FormToaGhe(Model_Tau chuyen2,HoaDon hoaDon, List<ChoNgoi> list,Map<String, Set<ChoNgoi>> listChoChon,DefaultTableModel model, List<Model_InfoVe> listInfoVes) {
    	this.list = list;
    	this.model = model;
    ...
    public void addItemKhoang(int from, int to){
        KhoangGhe item = new KhoangGhe(list,hoaDon,listChon,listInfoVes,model,chuyen,from,to);
