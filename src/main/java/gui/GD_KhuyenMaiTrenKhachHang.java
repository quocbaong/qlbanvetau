...
public class GD_KhuyenMaiTrenKhachHang extends javax.swing.JPanel {
	...
	public GD_KhuyenMaiTrenKhachHang(EntityManagerFactory emf) {
		...
		formTable.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.WHITE),
				"Khuyễn mãi theo đối tượng", 0, HEIGHT, new Font(Font.SANS_SERIF, Font.PLAIN, 14) {
				}, Color.WHITE));
    ...
    private void initComponents() {
        ...
        setPreferredSize(new Dimension(1295, 901));
        			...
        			.addGroup(formTableLayout.createParallelGroup(Alignment.LEADING)
        				.addGroup(formTableLayout.createSequentialGroup()
        					...
        					.addGroup(formTableLayout.createParallelGroup(Alignment.LEADING)
        						...
        						.addComponent(btnNgung, GroupLayout.PREFERRED_SIZE, 350, GroupLayout.PREFERRED_SIZE)))
        				.addGroup(formTableLayout.createSequentialGroup()
        					.addGap(8)
        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(formTable, GroupLayout.PREFERRED_SIZE, 1288, GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addGap(18)
        			.addComponent(formTable, GroupLayout.PREFERRED_SIZE, 822, GroupLayout.PREFERRED_SIZE)
