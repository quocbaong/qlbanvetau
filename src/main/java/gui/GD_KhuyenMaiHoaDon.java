    ...
    private void initComponents() {
        	...
        	formTableLayout.createParallelGroup(Alignment.LEADING)
        		.addGroup(formTableLayout.createSequentialGroup()
        			...
        			.addGroup(formTableLayout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 742, GroupLayout.PREFERRED_SIZE)
        				.addGroup(formTableLayout.createSequentialGroup()
        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addComponent(formTable, GroupLayout.PREFERRED_SIZE, 1301, GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(formTable, GroupLayout.PREFERRED_SIZE, 839, GroupLayout.PREFERRED_SIZE)
